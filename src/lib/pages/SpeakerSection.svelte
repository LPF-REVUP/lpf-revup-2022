            ...
            <div class="p-4">
              <a href={`/speaker/${speaker.id}`}>
                <img
                  ...
                  class="md:w-48 w-30 object-cover rounded-[50%]"
                />
                <div class="flex flex-col">
                  <h3 class="text-lg text-center text-white font-bold">
                    {`${speaker.familyNameJp} ${speaker.firstNameJp}`}
                  </h3>
                  <h4 class="text-md text-center leading-8 text-white font-normal">
